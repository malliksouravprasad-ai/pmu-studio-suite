...
_user_tag = _col_tag.text_input("Your Name / User Tag",
    ...
    placeholder="e.g. Malli, District_A, Team_FLN", key="ws_tag_005")
st.session_state["pmu_user_tag"] = _user_tag.strip()
if _col_clr.button("Clear", key="ws_clr_005", use_container_width=True):
...
_show_all = st.toggle("Show all users' workspaces", value=False, key="ws_all_005")
